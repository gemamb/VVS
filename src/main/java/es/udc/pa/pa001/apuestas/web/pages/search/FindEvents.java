...
public class FindEvents {
	...
	List<String> onProvideCompletionsFromKeyWords(String keyWords) {
        ...
        EventBlock events = betService.findEvents(keyWords, null, 0,10, userSession==null? false:userSession.isAdmin());
	...
	Object onSuccess() {
		...
		eventsDetails.setCategory(category==null ? null : Long.parseLong(category));
