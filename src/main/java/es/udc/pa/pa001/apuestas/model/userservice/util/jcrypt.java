...
public final class jcrypt {
   ...
   *          the offset
   */
  private static void intToFourBytes(final int iValue, final byte[] b,
      int offset) {
   ...
   *          the results
   */
  private static void PERM_OP(int a, int b, final int n,
      final int m, final int[] results) {
    int t;
   ...
   * @return the int
   */
  private static int D_ENCRYPT(int L, final int R, final int S,
      final int E0, final int E1,
      final int[] s) {
    int t, u, v;
