...
//		return (startIndex-EVENTS_PER_PAGE >=0) ? new Object[]{keyWords,category,startIndex-EVENTS_PER_PAGE} : null;
//	}
//	
//	public Object[] getNextLinkContext(){
//		return eventBlock.getExistMoreEvents() ? new Object[]{keyWords,category,startIndex+EVENTS_PER_PAGE} : null;
//	}
	...
	void onActivate(String keyWords,Long category, int startIndex){
		...
		findEventGridDataSource = new FindEventGridDataSource(
				betService, keyWords, category,admin);
		
		//eventBlock = betService.findEvents(keyWords, category, startIndex,EVENTS_PER_PAGE,admin);	
	}
