...
public class BetServiceUnitTest {
	...
	public void testMakeBet() throws InstanceNotFoundException,
		...
		UserProfile userProfileDemo = new UserProfile("pepe6", "XxXyYyZzZ",
				"Pepe", "García", "pepe6@gmail.com");

		Category categoryDemo = new Category("Baloncesto");

		Event eventDemo = new Event("Real Madrid - Barcelona",
		...
		BetOption betOptionDemo = new BetOption("Real Madrid CF", (float) 1.75,
				null, betTypeDemo);
	...
	public void testInsertPastedEvent() throws InstanceNotFoundException,
		...
		Calendar eventCalendar = Calendar.getInstance();
		eventCalendar.set(2016, Calendar.AUGUST, 31);
	...
	public void testInsertBetTypeDuplicateAnswer()
		...
		BetOption betOptionDemo2 = new BetOption("Real Madrid CF", (float) 1.5,
				null, betTypeDemo);
